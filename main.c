        ...
        switch (opcao) {
            case 1:
                ...
                }
                {
                    ...
                    getchar();
                    printf("Digite o número do seu tipo de investimento: \n[0] Prefixado \n[1] IPCA+ \n[2] Selic \n[3] CDI.\n\n-  ");
            ...
            case 2:
                ...
                getchar();
                printf("Digite o novo Papel/Ativo: ");
                ...
                getchar();
                printf("Digite o novo número do seu tipo de investimento: \n[0] Prefixado \n[1] IPCA+ \n[2] Selic \n[3] CDI.\n\n-  ");
